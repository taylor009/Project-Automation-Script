...
declare -a dirArr=("config" "controllers" "models" "routes" "utils")
...
yarn add @babel/core @babel/node @babel/register @babel/preset-env mocha chai chai-as-promised cross-env nyc sinon nodemon --dev

yarn add express body-parser morgan dotenv winston neo4j-driver neode
